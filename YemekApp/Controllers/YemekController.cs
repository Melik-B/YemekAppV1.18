...
namespace YemekApp.Controllers
{
    ...
    public class YemekController : Controller
    {
        ...
        {
            return View(_yemekTarifiService.Query().ToList());
        }
        ...
        public IActionResult Create()
        {
            ...
            var group1 = new SelectListGroup() { Name = "Malzemeler" };

            ViewBag.Malzeme = new List<SelectListItem>()
            {
                new SelectListItem(){Text = "Muz", Value = model.MalzemeId.Value.ToString(), Group = group1},
                new SelectListItem(){Text = "Süt", Value = "2", Group = group1}
            };
